    ...
    <>
      ...
      <div className="fixed bottom-6 left-6 z-40">
        <div className="relative group">
          ...
          <a href="tel:+201113081409" className="w-14 h-14 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full shadow-lg hover:shadow-xl transform hover:scale-110 transition-all duration-300 flex items-center justify-center text-white" title="اتصل الآن">
