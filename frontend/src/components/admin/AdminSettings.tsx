  ...
  return (
    <div className="space-y-8">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">⚙️ إعدادات الجيم</h3>
        {loading ? (
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-sm text-gray-700 dark:text-gray-300 mb-1">🖼️ رابط الشعار</label>
              ...
              <div>
                <label className="block text-sm text-gray-700 dark:text-gray-300 mb-1">✉️ البريد</label>
